...
/**
 *typedef struct fm fmt_t - struc op
 *@fmt:the format
...
int handle_write_char(va_list types, char buffer[],
		int flags, int width, int precision, int size);
int write_number(va_list types, char buffer[],
		int flags, int width, int precision, int size);
int write_num(va_list types, char buffer[],
		int flags, int width, int precision, int size);
